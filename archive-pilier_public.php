...
<?php query_posts(array( 'post_type' => 'pilier_public')); ?>
...
<?php endif; ?>
 	...
 	<div class="site-inner">
		...
		<div id="pilier_public">
		<?php if ( have_posts() ) : ?>
			<header class="entry-header">
            	<h1 class="entry-title">Pilier public</h1>
            </header>
							 ...
							 <div class="post">
								 <div class="entry">
									...
									while ( have_posts() ) : the_post();
										...
										get_template_part( 'template-parts/content', 'pilier_public' );
